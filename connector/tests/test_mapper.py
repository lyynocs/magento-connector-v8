...
from openerp.addons.connector.connector import Environ
...
class test_mapper_binding(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.env = Environ(backend_record, self.session, 'res.partner')
    ...
    def test_mapping_record_children_no_map_child(self):
        ...
        env = Environ(backend_record, self.session, 'res.currency')
